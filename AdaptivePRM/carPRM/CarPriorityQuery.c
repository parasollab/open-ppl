...
CarPriorityQuery::CarPriorityQuery(Input *input, MyQueryCmds *Qinput, CollisionDetection* cd, 
		 DistanceMetric* dm, PriorityLocalPlanners* lp,ConnectMapNodes* cn) :
	 PriorityQuery(input, Qinput, cd, dm, lp, cn) {}


CarPriorityQuery::~CarPriorityQuery() {}


// this is needed to make this method visible outside.
bool
CarPriorityQuery::PerformQuery(CollisionDetection* cd, ConnectMapNodes* cn, 
...
bool 
CarPriorityQuery::PerformQuery(Cfg _start, Cfg _goal, CollisionDetection *cd,
...
bool
CarPriorityQuery::GetPathSegment(Cfg _c1, Cfg _c2, CollisionDetection *cd,
   ...
   return PriorityQuery::GetPathSegment(_c1, _c2, cd, lp, dm, _weight, _ci);
}
