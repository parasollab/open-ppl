...
public:
    ...
    /**Matrix times vector.
      ...
      *Then multuply this matrix with a given vector.
    ...
    /** Swap Aij to Aji in orientation matix.
      ...
      * @warning Should this function be called Transpose?
      */
    void Invert();
    ...
    /**Convert the Orientation instance from current type to specified type.
      ...
      *@see OrientationType for more type information.
      *@todo There is a lot of to do marks in implemetation (.cpp) of this function.
      */
