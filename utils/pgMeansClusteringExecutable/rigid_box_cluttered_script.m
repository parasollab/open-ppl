...
data = importdata('/users/tmadison/PRM_Code/SpatioTemporalStudy/Problems/Rigid-box-cluttered/mediumCluttered/SampleDataPoints.txt',' ');
...
fileName = '/users/tmadison/PRM_Code/SpatioTemporalStudy/Problems/Rigid-box-cluttered/mediumCluttered/pgmeansClusterOutput.txt';
...
fName = '/users/tmadison/PRM_Code/SpatioTemporalStudy/Problems/Rigid-box-cluttered/mediumCluttered/ClusterInformation.txt';
...
fName3 = '/users/tmadison/PRM_Code/SpatioTemporalStudy/Problems/Rigid-box-cluttered/mediumCluttered/numClusters.txt';
