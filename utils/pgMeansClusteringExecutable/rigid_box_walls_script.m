...
data = importdata('/users/tmadison/PRM_Code/SpatioTemporalStudy/Problems/Rigid-box-Walls/SampleDataPoints.txt',' ');
...
fileName = '/users/tmadison/PRM_Code/SpatioTemporalStudy/Problems/Rigid-box-Walls/pgmeansClusterOutput.txt';
...
fName = '/users/tmadison/PRM_Code/SpatioTemporalStudy/Problems/Rigid-box-Walls/ClusterInformation.txt';
...
fName3 = '/users/tmadison/PRM_Code/SpatioTemporalStudy/Problems/Rigid-box-Walls/numClusters.txt';
