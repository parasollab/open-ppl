...
//===================================================================
ConnectCCsCmds::ConnectCCsCmds(): defaultFile("-f"), mapFile("-inmapFile"), option_str("-connectCCsMethod") {
...
//===================================================================
int ConnectCCsCmds::ReadCommandLine(int *argc, char **argv){
  vector<char*> cmd; 
  cmd.reserve(*argc);
...
void ConnectCCsCmds::PrintUsage(ostream& _os,char *executablename){
...
void ConnectCCsCmds::PrintValues(ostream& _os){
