...
int main(int argc, char *argv[])
{
  ...
  for (int sample = 0; sample != 10; ++sample)
  {
    ...
    std::for_each(x.begin(), x.end(), [](data_t &n){ n = n*n; });

    for_each_samples[sample] = stop_timer(time);

    auto for_each_result = std::accumulate(x.begin(), x.end(), 0.);
  ...
  report_result("b_for_each","STL",for_each_correct, for_each_samples);
  report_result("b_find-No -- not present","STL",
                find_correct, find_samples0);
  report_result("b_find-25 -- elem at 25%","STL",
                find_correct, find_samples25);
  report_result("b_find-75 -- elem at 75%","STL",
                find_correct, find_samples75);
  report_result("b_find_if-No -- not present","STL",
                find_if_correct, find_if_samples0);
  report_result("b_find_if-25 -- elem at 25%","STL",
                find_if_correct, find_if_samples25);
  report_result("b_find_if-75 -- elem at 75%","STL",
                find_if_correct, find_if_samples75);
  report_result("b_find_first_of-No -- not present","STL",
                find_first_of_correct, find_first_of_samples0);
  report_result("b_find_first_of-25 -- elem at 25%","STL",
                find_first_of_correct, find_first_of_samples25);
  report_result("b_find_first_of-75 -- elem at 75%","STL",
                find_first_of_correct, find_first_of_samples75);
  report_result("b_adjacent_find-No -- not present","STL",
                adjacent_find_correct, adjacent_find_samples0);
  report_result("b_adjacent_find-25 -- elem at 25%","STL",
                adjacent_find_correct, adjacent_find_samples25);
  report_result("b_adjacent_find-75 -- elem at 75%","STL",
                adjacent_find_correct, adjacent_find_samples75);
  report_result("b_count","STL",count_correct, count_samples);
  report_result("b_count_if","STL",count_if_correct, count_if_samples);
  report_result("b_equal-all -- all equal","STL",
                equal_correct, equal_samples0);
  report_result("b_equal-25 -- unequal at 25%","STL",
                equal_correct, equal_samples25);
  report_result("b_equal-75 -- unequal at 75%","STL",
                equal_correct, equal_samples75);
  report_result("b_mismatch-No -- no mismatch","STL",
                mismatch_correct, mismatch_samples0);
  report_result("b_mismatch-25 -- mismatch at 25%","STL",
                mismatch_correct, mismatch_samples25);
  report_result("b_mismatch-75 -- mismatch at 75%","STL",
                mismatch_correct, mismatch_samples75);
  report_result("b_search-No -- no substring","STL",
                search_correct, search_samples0);
  report_result("b_search-25 -- substring at 25%","STL",
                search_correct, search_samples25);
  report_result("b_search-75 -- substring at 75%","STL",
                search_correct, search_samples75);
  report_result("b_search_n-No -- no substring","STL",
                search_correct, search_n_samples0);
  report_result("b_search_n-25 -- substring at 25%","STL",
                search_correct, search_n_samples25);
  report_result("b_search_n-75 -- substring at 75%","STL",
       ...
       bool& correct, int sample)
{
  ...
  auto result = std::find(x.begin(), x.end(), data_val);
  ...
  result = std::find(x.begin(), x.end(), data_val);
       ...
       bool& correct, int sample)
{
  ...
  auto result = std::find_if(x.begin(), x.end(), equal_known(data_val));
  ...
  result = std::find_if(x.begin(), x.end(), equal_known(data_val));
       ...
       bool& correct, int sample)
{
  ...
  auto result = std::find_first_of(x.begin(), x.end(),
  ...
  result = std::find_first_of(x.begin(), x.end(),
             search_space.begin(), search_space.end());
       ...
       bool& correct, int sample)
{
  ...
  auto result = std::adjacent_find(x.begin(), x.end());
  ...
  result = std::adjacent_find(x.begin(), x.end());
       ...
       bool& correct, int sample)
{
  ...
  auto result = std::count(x.begin(), x.end(), data_val);
       ...
       bool& correct, int sample)
{
  ...
  auto result = std::count_if(x.begin(), x.end(), equal_known(data_val));
       ...
       bool& mismatch_correct, bool& equal_correct, int sample)
{
  ...
  bool equal_result = std::equal(x.begin(), x.end(), y.begin());
  ...
  auto mismatch_result = std::mismatch(x.begin(), x.end(), y.begin());
  ...
  equal_result = std::equal(x.begin(), x.end(), y.begin());
  ...
  mismatch_result = std::mismatch(x.begin(), x.end(), y.begin());
       ...
       bool& search_correct, bool search_n_correct, int sample)
{
  ...
  auto result = std::search(x.begin(), x.end(),
  ...
  result = std::search_n(x.begin(), x.end(), 25, data_val);
  ...
  result = std::search(x.begin(), x.end(),
             substring.begin(), substring.end());
