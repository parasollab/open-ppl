...
#ifndef KRIPKE_BOUNDARY_KERNEL_3D_GZD_H__
#define KRIPKE_BOUNDARY_KERNEL_3D_GZD_H__
...
public:
  ...
  gzd_zd_boundary_gen(plane_t * plane, int idx_max,
...
public:
  ...
  result_type operator()(index_type const& idx) const
  {
    ...
    return {value_gen, value_gen, value_gen};
  }
...
struct gzd_g_boundary_gen_type
{
  static constexpr direction dir = (direction)axis_num;
  using type = gzd_g_boundary_gen<1, 2>;
};

template<>
struct gzd_g_boundary_gen_type<1>
{
  static constexpr direction dir = (direction)1;
  using type = gzd_g_boundary_gen<0, 2>;
};

template<>
struct gzd_g_boundary_gen_type<2>
{
  static constexpr direction dir = (direction)2;
  using type = gzd_g_boundary_gen<0, 1>;
};
...
template <size_t dir>
struct grid_boundary_traits<dir, NEST_GZD>
{
  ...
  using boundary_gen_t   = typename gzd_g_boundary_gen_type<dir>::type;
...
#endif // KRIPKE_BOUNDARY_KERNEL_3D_GZD_H__
