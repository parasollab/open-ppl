...
#ifndef KRIPKE_BOUNDARY_KERNEL_3D_ZGD_H__
#define KRIPKE_BOUNDARY_KERNEL_3D_ZGD_H__
...
public:
  ...
  zgd_boundary_gen(plane_t * plane,
...
struct zgd_boundary_gen_type
{
  static constexpr direction dir = (direction)axis_num;
  using type = zgd_boundary_gen<1, 2>;
};

template<>
struct zgd_boundary_gen_type<1>
{
  static constexpr direction dir = (direction)1;
  using type = zgd_boundary_gen<0, 2>;
};

template<>
struct zgd_boundary_gen_type<2>
{
  static constexpr direction dir = (direction)2;
  using type = zgd_boundary_gen<0, 1>;
};
...
struct grid_boundary_traits<dir, NEST_ZGD>
{
                                 ...
                                 size_t num_directions)
  {
    ...
    auto&& boundary_spec =
      make_boundary_spec(num_zones, zone_size, locations);
...
#endif // KRIPKE_BOUNDARY_KERNEL_3D_ZGD_H__
