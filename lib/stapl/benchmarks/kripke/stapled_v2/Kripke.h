...
enum Nesting_Order {
  ...
  // Nestings for L and L+ matrices, currently unused.
  NEST_DNM,
  NEST_NMD
};
...
/**
 * Tags to determine current nesting level
 */
enum class Nesting : std::size_t {Direction, Group, Zone};

namespace tags {

template <enum Nesting_Order, enum Nesting>
struct kripke { };
