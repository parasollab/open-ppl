...
// File differs from Boost distribution by providing define_type functions to
// allow data structures defined here to be marshaled.
...
public:
  ...
  {
    t.base<super_type>(*this);
    t.member(base_, num_elements_);
    t.member(storage_);
    t.member(extent_list_);
    t.member(stride_list_);
    t.member(index_base_list_);
    t.member(origin_offset_);
    t.member(directional_offset_);
    t.member(num_elements_);
  }
#endif
