...
// The edge's data members are instances of Boost.Optional, and the
// unconditional comparison of edges.first causes gcc to issue a warning.
// Checking to ensure the data members are initialized before performing the
// comparison eliminates the warning.
// See https://svn.boost.org/trac/boost/ticket/5706 for details and progress
// from Boost on resolving the issue in the release.
