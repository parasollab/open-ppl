 ...
 * George
 *
 * $Id: struct.h 1866 2004-02-27 17:06:42Z gabrielt $
 */
...
struct controldef {
  ...
  /* Various Timers */
  metis_timer TotalTmr;
  metis_timer  InitPartTmr;
  metis_timer MatchTmr;
  metis_timer ContractTmr;
  metis_timer  CoarsenTmr;
  metis_timer  UncoarsenTmr;
  metis_timer  SepTmr;
  metis_timer RefTmr;
  metis_timer  ProjectTmr;
  metis_timer SplitTmr;
  metis_timer AuxTmr1;
  metis_timer AuxTmr2;
  metis_timer AuxTmr3;
  metis_timer AuxTmr4;
