...
public:
  ...
  typedef twod_tag dimension_tag; /* name clash a problem */
...
public:
  ...
  inline symmetric_matrix(pointer d, size_type n, int uplo_, int sub)
    : Base(d, n, n,  /* jkp/02may2005 - one of these n's was a m' (the first) but there is no m passed... assume NxN matrix (symmetric) */
