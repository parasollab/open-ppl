...
template <class VecX, class VecY, class VecZ> inline void add(const VecX& x, const VecY& y, MTL_OUT(VecZ) z_) MTL_THROW_ASSERTION;
template <class VecW, class VecX, class VecY, class VecZ> inline void add(const VecX& x, const VecY& y, const VecZ& z, MTL_OUT(VecW) w_) MTL_THROW_ASSERTION;
template <class LinalgA, class LinalgB> inline void add(const LinalgA& A, MTL_OUT(LinalgB) B_) MTL_THROW_ASSERTION;
template <class VecX, class VecY> inline typename VecX::value_type dot(const VecX& x, const VecY& y) MTL_THROW_ASSERTION;
template <class LinalgA, class LinalgB> inline void copy(const LinalgA& A, MTL_OUT(LinalgB) B_) MTL_THROW_ASSERTION;
...
{
  typedef typename linalg_traits<LinalgObj>::dimension_tag Dim;
...
mult(const LinalgA& A, const LinalgB& B, MTL_OUT(LinalgC) C_)
{
  ...
  typedef typename linalg_traits<LinalgB>::dimension_tag Dim;
...
copy(const LinalgA& A, MTL_OUT(LinalgB) B_) MTL_THROW_ASSERTION
{
  ...
  typedef typename linalg_traits<LinalgA>::dimension_tag Dim;
  copy__(A, B, Dim());
}
