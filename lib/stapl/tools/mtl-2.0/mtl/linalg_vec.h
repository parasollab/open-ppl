...
public:
  ...
  public:
	...
	while (*i == this->Vec_value_type(0)) ++i;
      }
      reference operator*() const { return i.index(); }
      iterator& operator++() { 
	++i; while (*i == this->Vec_value_type(0) && i != end) ++i;
	return *this; }
	...
	: i(iter), end(e) { 
	while (*i == this->Vec_value_type(0) && i != end) ++i;
      }
      reference operator*() const { return i.index(); }
	...
	const_iterator t = *this; ++(*this); return t; }
      const_iterator& operator--() { 
	--i; while (*i == this->Vec_value_type(0)) --i;
	return *this; }
      const_iterator operator--(int) { 
	const_iterator t = *this; --(*this); return t; }
