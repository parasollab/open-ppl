...
#ifndef STAPL_CONTAINERS_UNORDERED_SET_PROXY_HPP
#define STAPL_CONTAINERS_UNORDERED_SET_PROXY_HPP
...
//////////////////////////////////////////////////////////////////////
/// @brief Specialization used when the type is an unordered set.
///   Refer to @ref unordered set for proper use of the container
///   itself.
/// @ingroup punorderedset
////////////////////////////////////////////////////////////////////////
template<typename Key, typename ...OptionalParams, typename Accessor>
class proxy<stapl::unordered_set<Key, OptionalParams...>, Accessor>
  : public Accessor
{
private:
  friend class proxy_core_access;

  typedef stapl::unordered_set<Key, OptionalParams...>      target_t;
...
#endif // STAPL_CONTAINERS_UNORDERED_SET_PROXY_HPP
