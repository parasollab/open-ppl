...
#ifndef STAPL_CONTAINERS_MULTIGRAPH_HPP
#define STAPL_CONTAINERS_MULTIGRAPH_HPP
...
//////////////////////////////////////////////////////////////////////
/// @brief Creates an UNDIRECTED, MULTIEDGES graph.
...
class multigraph
  : public graph<UNDIRECTED, MULTIEDGES, OptionalParams...>
{
  typedef graph<UNDIRECTED, MULTIEDGES, OptionalParams...>  base_type;
  typedef multigraph<OptionalParams...>                     this_type;
  typedef typename graph_directedness_container_selector<
    UNDIRECTED, MULTIEDGES, OptionalParams...>::type        directed_base_type;
...
public:
  ...
  //////////////////////////////////////////////////////////////////////
  multigraph(typename base_type::partition_type const& ps,
             typename base_type::vertex_property const& default_value
               =typename base_type::vertex_property())
...
#endif /* STAPL_CONTAINERS_MULTIGRAPH_HPP */
