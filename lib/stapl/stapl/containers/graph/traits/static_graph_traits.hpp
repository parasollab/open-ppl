...
#ifndef STAPL_CONTAINERS_GRAPH_STATIC_GRAPH_TRAITS_HPP
#define STAPL_CONTAINERS_GRAPH_STATIC_GRAPH_TRAITS_HPP
...
struct construct_container_registry
{
  typedef interval_container_registry<BaseContainer> type;
};

template<typename BaseContainer, typename Domain>
struct construct_container_registry<BaseContainer, balanced_partition<Domain> >
{
...
struct static_graph_traits
{
  ...
  typedef graph_base_container<graph_base_container_traits<D,M,VertexP,EdgeP,
                                                           domain_type> >
                                                         base_container_type;
