...
#ifndef STAPL_RUNTIME_COUNTER_PAPI_PAPI_TIMER_HPP
#define STAPL_RUNTIME_COUNTER_PAPI_PAPI_TIMER_HPP
...
//////////////////////////////////////////////////////////////////////
/// @brief Time counter that uses PAPI.
///
/// @ingroup counters
//////////////////////////////////////////////////////////////////////
class papi_timer
...
public:
  ...
  { return (value_type(v) * 1.0E-6); }

private:
  raw_value_type m_v;

public:
  constexpr papi_timer(void) noexcept
  : m_v(0)
  { }
