...
void test_array(size_t n)
{
  typedef COMPOSE_CONTAINERS_type(NUM_COMP_LEVELS, array, int) container_t;
  ...
  std::string mtype = TEST_msg(NUM_COMP_LEVELS, array, int);
...
void test_static_array(size_t n)
{
  typedef COMPOSE_CONTAINERS_type(NUM_COMP_LEVELS,static_array,int) container_t;
  container_t COMPOSE_CONTAINERS_cntr(NUM_COMP_LEVELS,c,n);
  ...
  std::string mtype = TEST_msg(NUM_COMP_LEVELS, static_array, int);
  std::string msg = "Testing " + mtype;
  STAPL_TEST_REPORT(res == val, msg);
}
