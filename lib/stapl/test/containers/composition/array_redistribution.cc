...
stapl::exit_code stapl_main(int argc, char** argv)
{
  ...
  typedef stapl::array<double, vb_partition, vb_mapper>        inner_ct_t;
  typedef stapl::array<inner_ct_t, vb_partition, vb_mapper>    mid_ct_t;
  typedef stapl::array<mid_ct_t, vb_partition, vb_mapper>      outer_ct_t;
  ...
  stapl::do_once([&]() {
    std::cout << "Test: composed_array_construction\n"
              << "Status: ";
    if (ctor_passed)
      std::cout << "PASSED\n";
    else
  ...
  stapl::do_once([&]() {
    std::cout << "Test: composed_array_redistribution\n"
              << "Status: ";
    if (redist_passed)
      std::cout << "PASSED\n";
    else
