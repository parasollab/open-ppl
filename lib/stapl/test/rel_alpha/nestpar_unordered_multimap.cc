...
typedef stapl::unordered_multimap<int,int>            ump_int_tp;
typedef stapl::unordered_multimap<int,ump_int_tp>     ump_2_int_tp;
typedef stapl::unordered_multimap<int,ump_2_int_tp>   ump_3_int_tp;
...
typedef stapl::unordered_multimap<int,ary_int_tp>     ump_ary_int_tp;
typedef stapl::array<ump_int_tp>                 ary_ump_int_tp;
typedef stapl::unordered_multimap<int,map_int_tp>     ump_map_int_tp;
typedef stapl::map<int,ump_int_tp>               map_ump_int_tp;

typedef stapl::unordered_multimap<int,ump_ary_int_tp> ump_ump_ary_int_tp;
typedef stapl::unordered_multimap<int,ary_ump_int_tp> ump_ary_ump_int_tp;
typedef stapl::unordered_multimap<int,ump_map_int_tp> ump_ump_map_int_tp;
typedef stapl::unordered_multimap<int,map_ump_int_tp> ump_map_ump_int_tp;
