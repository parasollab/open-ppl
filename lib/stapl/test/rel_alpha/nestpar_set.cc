...
size_t nestpar_set_01(size_t, stapl::stream<ofstream>& );
#endif
#ifdef TEST_SET_2LVL_02
size_t nestpar_set_02(size_t, stapl::stream<ofstream>& );
#endif
#ifdef TEST_SET_2LVL_03
size_t nestpar_set_03(size_t, stapl::stream<ofstream>& );
#endif
#ifdef TEST_SET_2LVL_04
size_t nestpar_set_04(size_t, stapl::stream<ofstream>& );
#endif
#ifdef TEST_SET_2LVL_05
size_t nestpar_set_05(size_t, stapl::stream<ofstream>& );
#endif
#ifdef TEST_SET_2LVL_06
size_t nestpar_set_06(size_t,
                      stapl::stream<ifstream>&,
                      stapl::stream<ofstream>& );
#endif
#ifdef TEST_SET_3LVL_01
size_t nestpar_set_10(size_t, stapl::stream<ofstream>& );
#endif
#ifdef TEST_SET_3LVL_02
size_t nestpar_set_11(size_t, stapl::stream<ofstream>& );
#endif
#ifdef TEST_SET_3LVL_03
size_t nestpar_set_12(size_t, stapl::stream<ofstream>& );
#endif
#ifdef TEST_SET_3LVL_04
size_t nestpar_set_13(size_t, stapl::stream<ofstream>& );
#endif
#ifdef TEST_SET_3LVL_05
size_t nestpar_set_14(size_t, stapl::stream<ofstream>& );
#endif
#ifdef TEST_SET_3LVL_06
size_t nestpar_set_15(size_t, stapl::stream<ofstream>& );
#endif
...
void open_zin(int model, int test, stapl::stream<ifstream>& zin)
{
  ...
  case 1:
    switch( test ) {
    case 1:
      zin.open("data/tiny_factors.zin");
      break;
    default:
...
stapl::exit_code stapl_main(int argc, char **argv)
{
  ...
  for ( int test=first_test; test<=last_test; test++ ) {
    ...
    case 1:
      #ifdef TEST_SET_2LVL_01
      result = nestpar_set_01(model, zout);
      #else
      disabled = true;
      #endif
      break;
    case 2:
      #ifdef TEST_SET_2LVL_02
      result = nestpar_set_02(model, zout);
      #else
      disabled = true;
      #endif
      break;
    case 3:
      #ifdef TEST_SET_2LVL_03
      result = nestpar_set_03(model, zout);
      #else
      disabled = true;
      #endif
      break;
    case 4:
      #ifdef TEST_SET_2LVL_04
      result = nestpar_set_04(model, zout);
      #else
      disabled = true;
      #endif
      break;
    case 5:
      #ifdef TEST_SET_2LVL_05
      result = nestpar_set_05(model, zout);
      #else
      disabled = true;
      #endif
      break;
    case 6:
      #ifdef TEST_SET_2LVL_06
      result = nestpar_set_06(model, zin, zout);
      #else
      disabled = true;
      #endif
      break;
    case 7:
      #ifdef TEST_SET_3LVL_01
      result = nestpar_set_10(model, zout);
      #else
      disabled = true;
      #endif
      break;
    case 8:
      #ifdef TEST_SET_3LVL_02
      result = nestpar_set_11(model, zout);
      #else
      disabled = true;
      #endif
      break;
    case 9:
      #ifdef TEST_SET_3LVL_03
      result = nestpar_set_12(model, zout);
      #else
      disabled = true;
      #endif
      break;
    case 10:
      #ifdef TEST_SET_3LVL_04
      result = nestpar_set_13(model, zout);
      #else
      disabled = true;
      #endif
      break;
    case 11:
      #ifdef TEST_SET_3LVL_05
      result = nestpar_set_14(model, zout);
      #else
      disabled = true;
      #endif
      break;
    case 12:
      #ifdef TEST_SET_3LVL_06
      result = nestpar_set_15(model, zout);
      #else
      disabled = true;
      #endif
      break;
...
//////////////////////////////////////////////////////////////////////
// nested parallelism : vec(set(int))
// construct vector with generator, traverse with serial
//////////////////////////////////////////////////////////////////////
#ifdef TEST_SET_2LVL_01

size_t nestpar_set_01( size_t model, stapl::stream<ofstream>& zout)
{
  two_lvl_test_wrapper <vec_set_int_tp, vec_set_int_vw_tp> test_case;
  nestpar_size_process_wf proc;

  return test_case.run_test(model, "np_set_01.zout", proc, zout);
}
...
size_t nestpar_set_02( size_t model, stapl::stream<ofstream>& zout)
{
  two_lvl_test_wrapper <vec_set_int_tp, vec_set_int_vw_tp> test_case;
  nestpar_map_reduce_process_wf proc;
  return test_case.run_test(model, "np_set_02.zout", proc, zout);
}

#endif
//////////////////////////////////////////////////////////////////////
// nested parallelism : ary(set(int))
// construct array with generator, traverse with mapreduce
//////////////////////////////////////////////////////////////////////
#ifdef TEST_SET_2LVL_03
size_t nestpar_set_03( size_t model, stapl::stream<ofstream>& zout)
{
  two_lvl_test_wrapper <ary_set_int_tp, ary_set_int_vw_tp> test_case;
  nestpar_map_reduce_process_wf proc;
  return test_case.run_test(model, "np_set_03.zout", proc, zout);
}
#endif
//////////////////////////////////////////////////////////////////////
// nested parallelism : map(set(int))
...
size_t nestpar_set_04( size_t model, stapl::stream<ofstream>& zout)
{

  size_t size = 100 * model;
  size_t limit = 100 * model;
  set_random_seed();
  zout.open("np_set_04.zout");
...
size_t nestpar_set_05( size_t model, stapl::stream<ofstream>& zout)
{
  two_lvl_test_wrapper_mapreduce <vec_set_int_tp, vec_set_int_vw_tp> test_case;
  nestpar_set_05_process_wf proc;

  return test_case.run_test(model, "np_set_05.zout", proc, zout);
}
#endif
...
size_t nestpar_set_06( size_t model, stapl::stream<ifstream>& zin,
                       stapl::stream<ofstream>& zout)
{
  ...
  nestpar_map_reduce_process_wf proc;
  return test_case.run_test(model, "np_set_06.zout", proc, zin, zout);
}
#endif


//////////////////////////////////////////////////////////////////////
// nested parallelism : vec(vec(set(int))
// construct array with serial I/O,
// process with mapreduce / work function, display with serial
//////////////////////////////////////////////////////////////////////

#ifdef TEST_SET_3LVL_01
size_t nestpar_set_10( size_t model, stapl::stream<ofstream>& zout)
{
  three_lvl_test_wrapper <vec_vec_set_int_tp, vec_vec_set_int_vw_tp> test_case;
  nestpar_size_process_wf proc;
  return test_case.run_test(model, "np_set_10.zout", proc, zout );
}
#endif
...
//////////////////////////////////////////////////////////////////////
#ifdef TEST_SET_3LVL_03
size_t nestpar_set_12( size_t model, stapl::stream<ofstream>& zout )
{
  three_lvl_test_wrapper <vec_ary_set_int_tp, vec_ary_set_int_vw_tp> test_case;
  nestpar_map_reduce_process_wf proc;
  return test_case.run_test(model, "np_set_12.zout", proc, zout );
}
#endif
...
//////////////////////////////////////////////////////////////////////
#ifdef TEST_SET_3LVL_04
size_t nestpar_set_13( size_t model, stapl::stream<ofstream>& zout )
{
  three_lvl_test_wrapper <ary_vec_set_int_tp, ary_vec_set_int_vw_tp> test_case;
  nestpar_map_reduce_process_wf proc;
  return test_case.run_test(model, "np_set_13.zout", proc, zout );
}
#endif
...
size_t nestpar_set_14( size_t model, stapl::stream<ofstream>& zout )
{

  size_t size = 100 * model;
  size_t limit = 100 * model;
  set_random_seed();
  zout.open("np_set_14.zout");
...
size_t nestpar_set_15( size_t model, stapl::stream<ofstream>& zout )
{

  size_t size = 100 * model;
  size_t limit = 100 * model;
  set_random_seed();
  zout.open("np_set_15.zout");
