...
//////////////////////////////////////////////////////////////////////
/// @file
/// Test @ref std::make_immutable_range() and
/// @ref std::make_immutable_range_n().
//////////////////////////////////////////////////////////////////////
...
public:
  ...
  void test_make_immutable_range(void)
  {
    ...
    auto r = make_immutable_range(first, last);
  ...
  void test_make_immutable_range_n(void)
  {
    std::vector<int> v1 = { 0, 1, 2, 3, 4, 5, 6 };
    ...
    auto r = make_immutable_range_n(first, (v1.size() - 1));
  ...
  void test_self(void)
  {
    ...
    auto r = make_immutable_range(std::begin(v), std::end(v));
    ...
    async_rmi(this->get_location_id(), this->get_rmi_handle(),
              &p_test::test_same_ptr<decltype(r), int>,
              r, raw_ptr<int>{&v[0]});
  ...
  void test_self_copy(void)
  {
    ...
    // copy range
    async_rmi(this->get_location_id(), this->get_rmi_handle(),
              &p_test::test_diff_ptr<decltype(r), p_test*>,
              r, raw_ptr<p_test*>{&v[0]});

    // move range
    async_rmi(this->get_location_id(), this->get_rmi_handle(),
              &p_test::test_diff_ptr<decltype(r), p_test*>,
              std::move(r), raw_ptr<p_test*>{&v[0]});
  ...
  void execute(void)
  {
    test_make_immutable_range();
    test_make_immutable_range_n();
    test_self();
    test_self_copy();
  }
};
