  ...
  public:
    ...
    public:
      using in_flow_0_type =
        std::tuple<typename std::tuple_element <0, In>::type>;

      using out_port_0_type =
        typename std::tuple_element<0, skeletons_t>::type::
      ...
      using out_port_1_type =
        typename std::tuple_element<1, skeletons_t>::type::
      ...
      {
        return flows::concat(out_port_0(compose, in, lid_offset),
      ...
      using out_port_2_type =
        typename std::tuple_element<2, skeletons_t>::type::
      ...
      {
        return out_port_1(compose, in, lid_offset);
      }
            ...
            std::integral_constant<bool, false> /*!is_last*/)
    {
      ...
      return concat(
        m_compose.template get_out_port<
          inner_flow_t, 0>(inner_flow, lid_offset),
        std::make_tuple(std::get<0>(in))
      );
    }
            ...
            std::integral_constant<bool, true> /*!is_last*/)
    {
      ...
      return m_compose.template get_out_port<inner_flow_t , 1>(inner_flow,
                                                               lid_offset);
    }
