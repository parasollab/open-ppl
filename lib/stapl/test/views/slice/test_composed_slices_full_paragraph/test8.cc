...
void test_2d_1d_1d_1d_balanced(dims_type<5> const& dims)
{
  ...
  auto sv2 = make_slices_view<1, 2, 3>(sv1);
  auto sv30 = make_slices_view<0, 1>(sv2);
  auto sv31 = make_slices_view<1, 2>(sv2);
  ...
  STAPL_TEST_REPORT(passed,
    "Composed slices (balanced distribution) + skeletons (2-1-1-1)");
}
...
exit_code stapl_main(int argc, char** argv)
{
  ...
  test_2d_1d_1d_1d_balanced(dims_5d);
