...
void test_2d_1d_1d_1d_sliced(dims_type<5> const& dims)
{
 ...
 using sliced_part_t   = sliced_md_distribution_spec<
  ...
  auto sv3 = make_slices_view<0, 1>(sv2);
  ...
  map_func(lev1_intermediate_view(), sv3, sv3);
  ...
  STAPL_TEST_REPORT(passed,
    "Composed slices (sliced distribution) + skeletons (2-1-1-1)");
}
...
exit_code stapl_main(int argc, char** argv)
{
  ...
  test_2d_1d_1d_1d_sliced(dims_5d);
