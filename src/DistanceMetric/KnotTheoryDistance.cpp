...
KnotTheoryDistance::KnotTheoryDistance() : DistanceMetricMethod() {
  m_name = "KnotTheory";  
}

KnotTheoryDistance::
KnotTheoryDistance(XMLNodeReader& _node, MPProblem* _problem, bool _warn) : DistanceMetricMethod(_node, _problem, _warn) {
  m_name = "KnotTheory";  
}
