...
class Boundary {
  ...
  public:
    ...
    const Point3d& GetCenter() const noexcept {return m_center;}
    ...
    virtual const bool InBoundary(const Vector3d& _p) const = 0;
    ...
    ///         this boundary.
    virtual const bool InBoundary(const Cfg& _c) const;
