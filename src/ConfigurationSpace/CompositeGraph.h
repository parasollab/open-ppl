...
class CompositeGraph : public GenericStateGraph<CompositeState<GraphType>, CompositeEdge<GraphType>> {
  ...
  public:
    ...
    typedef GenericStateGraph<CompositeState<GraphType>, CompositeEdge<GraphType>> BaseType;
    ...
    CompositeGraph(RobotGroup* const _g, std::vector<GraphType*> _graphs = {});
    ...
    GraphType* GetRoadmap(const size_t _index);
    const GraphType* GetRoadmap(const size_t _index) const;
  ...
  protected:
    ...
    std::vector<GraphType*> m_roadmaps; ///< The individual roadmaps.
...
template <typename GraphType>
CompositeGraph<GraphType>::
CompositeGraph(RobotGroup* const _g, std::vector<GraphType*> _graphs) :
  GenericStateGraph<CompositeState<GraphType>, CompositeEdge<GraphType>>(nullptr),
...
template <typename GraphType>
inline
typename CompositeGraph<GraphType>::IndividualRoadmap*
CompositeGraph<GraphType>::
...
template <typename GraphType>
inline
const typename CompositeGraph<GraphType>::IndividualRoadmap*
CompositeGraph<GraphType>::
...
ClearHooks() noexcept {
  ...
  for(GraphType* const map : m_roadmaps)
    map->ClearHooks();
}
