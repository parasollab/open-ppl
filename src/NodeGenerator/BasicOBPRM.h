...
class BasicOBPRM : public NodeGenerationMethod<CFG> {
 ...
 protected:
   ...
   */
  static Vector3D PointOnBody(shared_ptr<Body> body, int select, bool isFreeBody);
   ...
   */
  static Vector3D ChooseRandomVertexOnBody(shared_ptr<Body> body, bool isFreeBody);
   ...
   */
  static Vector3D ChooseRandomTriangleOnBody(shared_ptr<Body>, bool);
   ...
   *and GMSPolyhedron::vertexList.
   */
  static Vector3D ExtremeVertex(shared_ptr<Body>, bool isFreeBody);
   ...
   *GMSPolyhedron::vertexList, and GMSPolyhedron::polygonList.
   */
  static Vector3D ChooseRandomWeightedTriangleOnBody(shared_ptr<Body> body, bool isFreeBody);
...
Vector3D
BasicOBPRM<CFG>::
PointOnBody(shared_ptr<Body> body, int select, bool isFreeBody) {
  Vector3D pt;
  int opt;
...
Vector3D
BasicOBPRM<CFG>::
ChooseRandomVertexOnBody(shared_ptr<Body> body, bool isFreeBody) {
  ...
  return polyhedron.vertexList[(int)(OBPRM_drand()*polyhedron.vertexList.size())];
};
...
Vector3D
BasicOBPRM<CFG>::
ChooseRandomTriangleOnBody(shared_ptr<Body> body, bool isFreeBody) {
  GMSPolyhedron polyhedron;
  // for robot, choose body frame; for obstacle, choose world frame
  if(isFreeBody)
    polyhedron = body->GetPolyhedron();
...
Vector3D
BasicOBPRM<CFG>::
ExtremeVertex(shared_ptr<Body> body, bool isFreeBody) {
  GMSPolyhedron polyhedron;
  // for robot, choose body frame; for obstacle, choose world frame
  if(isFreeBody) 
    polyhedron = body->GetPolyhedron();
...
Vector3D
BasicOBPRM<CFG>::
ChooseRandomWeightedTriangleOnBody(shared_ptr<Body> body, bool isFreeBody) {
  GMSPolyhedron polyhedron;
  // for robot, choose body frame; for obstacle, choose world frame
  if(isFreeBody){
    polyhedron = body->GetPolyhedron();
