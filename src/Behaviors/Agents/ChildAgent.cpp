...
ChildAgent::
ChildAgent(Robot* const _r) : Agent(_r) {

}

ChildAgent::
ChildAgent(Robot* const _r, XMLNode& _node) : Agent(_r,_node) {
  // m_controlChannel = _node.Read("controlChannel",false,"","Channel to publish controls to.");
}

ChildAgent::
ChildAgent(Robot* const _r, const ChildAgent& _a) : Agent(_r,_a)
{ }
...
Step(const double _dt) {
  ...
  // }
  // std::cout << "Here: " << this->m_robot->GetLabel() << "\n" << std::endl;
