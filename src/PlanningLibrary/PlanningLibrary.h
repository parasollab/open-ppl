...
#include "PlanningLibrary/Connectors/ConnectorMethod.h"
#include "PlanningLibrary/DistanceMetrics/DistanceMetricMethod.h"
#include "PlanningLibrary/Extenders/ExtenderMethod.h"
#include "PlanningLibrary/LocalPlanners/LocalPlannerMethod.h"
#include "PlanningLibrary/MapEvaluators/MapEvaluatorMethod.h"
#include "PlanningLibrary/Metrics/MetricMethod.h"
#include "PlanningLibrary/MPStrategies/MPStrategyMethod.h"
#include "PlanningLibrary/NeighborhoodFinders/NeighborhoodFinderMethod.h"
#include "PlanningLibrary/PathModifiers/PathModifierMethod.h"
#include "PlanningLibrary/Samplers/SamplerMethod.h"
...
///
/// The PlanningLibrary represents a collection of planning algorithms that can
/// operate on a specific MPProblem to solve its queries.
////////////////////////////////////////////////////////////////////////////////
template <typename MPTraits>
#ifdef _PARALLEL
class PlanningLibrary final : public stapl::p_object
#else
class PlanningLibrary final
#endif
{
...
Solve() {
  for(auto& sit : m_solvers) {
    ...
    // Call solver
    cout << "\n\nPlanningLibrary is solving with MPStrategyMethod labeled "
