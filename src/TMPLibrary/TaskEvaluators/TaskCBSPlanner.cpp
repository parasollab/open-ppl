...
*/
  ...
  *(this->GetTaskPlan()) = *(minPlan.get());
	...
	//this->GetMPLibrary()->GetStatClass()->SetStat("TotalNodes", totalNodes);
	this->GetMPLibrary()->GetStatClass()->SetStat("TotalNodes", nodesExplored+tree.Length());
	this->GetMPLibrary()->GetStatClass()->SetStat("MaxDepth", maxDepth);
	this->GetMPLibrary()->GetStatClass()->SetStat("MinNodeDepth", minNodeDepth);
	this->GetMPLibrary()->GetStatClass()->SetStat("NodesExplored", nodesExplored);
	this->GetMPLibrary()->GetStatClass()->SetStat("PlanCost", minPlan->GetEntireCost(m_makespan));
