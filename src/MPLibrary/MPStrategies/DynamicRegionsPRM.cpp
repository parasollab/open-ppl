...
bool
DynamicRegionsPRM::m_initialized = false;


WorkspaceSkeleton
DynamicRegionsPRM::m_skeleton;


typename DynamicRegionsPRM::LocalConnectivityMap
DynamicRegionsPRM::m_localComponents;


typename DynamicRegionsPRM::BridgeMap
DynamicRegionsPRM::m_bridges;


typename DynamicRegionsPRM::RegionMap
DynamicRegionsPRM::m_regions;


typename DynamicRegionsPRM::LowClearanceMap
DynamicRegionsPRM::m_lowClearanceMap;


typename DynamicRegionsPRM::UnconnectedEdgeMap
DynamicRegionsPRM::m_unconnectedEdges;
...
DynamicRegionsPRM::
DynamicRegionsPRM(XMLNode& _node) : MPStrategyMethod(_node) {
  this->SetName("DynamicRegionsPRM");
...
Initialize() {
  ...
  if(!m_initialized) {
    ...
    for(auto iter = skeletonGraph.begin(); iter != skeletonGraph.end(); ++iter) {
      ...
      const std::vector<Cfg> samples = Sample(&boundary);
...
CheckReachedRegion(const VID _query, const VertexSet& _component) {
  ...
  auto r = this->GetRoadmap();
  const Cfg& cfg = r->GetVertex(_query);
  auto& skeletonGraph = m_skeleton;
...
typename DynamicRegionsPRM::RoadmapType::VertexSet
DynamicRegionsPRM::
...
ConnectEdgeSegment(const SkeletonEdgeDescriptor _ed) {
  ...
  auto connector = [this](const Cfg& _cfg,
...
typename DynamicRegionsPRM::ExpansionRegion*
DynamicRegionsPRM::
...
typename DynamicRegionsPRM::LocalComponentDescriptor
DynamicRegionsPRM::
...
std::pair<std::vector<double>,
          std::vector<typename DynamicRegionsPRM::ExpansionRegion*>>
DynamicRegionsPRM::
...
std::vector<Neighbor>
DynamicRegionsPRM::
FindNearestNeighbors(const Cfg& _cfg, const VertexSet* const _candidates) {
  auto stats = this->GetStatClass();
...
bool
DynamicRegionsPRM::
AttemptConnection(const Cfg& _c1, const Cfg& _c2,
    LPOutput& _lpOutput) {
...
std::vector<typename DynamicRegionsPRM::EdgeOutput>
DynamicRegionsPRM::
ConnectToComponent(const Cfg& _cfg,
...
typename DynamicRegionsPRM::VID
DynamicRegionsPRM::
Extend(const VID _nearVID, const Cfg& _target, LPOutput& _lp) {
  ...
  const Cfg& qNear = r->GetVertex(_nearVID);
  Cfg qNew(qNear.GetRobot());
