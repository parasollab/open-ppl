...
//Calculate using Euclidean Distance then scaling
...
ScaledEuclideanDistance::ScaledEuclideanDistance(XMLNodeReader& _node, MPProblem* _problem, bool _warn) : 
  EuclideanDistance(_node, _problem, false) {
    m_name = "scaledEuclidean"; 
