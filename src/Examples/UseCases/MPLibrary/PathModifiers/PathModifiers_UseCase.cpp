void PathModifiersUseCase() {
    ...
    // The ouputPath will store the new path that is created by the
    // path modifier.
    Path outputPath;

    // The path modifier label is a string that corresponds to the XML node
    // label for the path modifier algorithm you would like to use.
    ...
    // algorithm on the inputPath to create a new path that is stored in
    // ouputPath.
