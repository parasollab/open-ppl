...
Vector3D 
Cfg_2D::GetRobotCenterofMass(Environment* _env) const {
...
bool Cfg_2D::ConfigEnvironment(Environment* _env) const {
  ...
  // update link 1.
  _env->GetMultiBody(robot)->GetFreeBody(0)->Configure(T1);
